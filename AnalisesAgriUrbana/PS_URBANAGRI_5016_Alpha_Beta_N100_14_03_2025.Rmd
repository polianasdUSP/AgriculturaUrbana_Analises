...
select("Sample.id", "shannon_entropy", "simpson", "pielou_evenness", "observed_features", "ACE", "chao1", "faith_pd","Sex", "Age", "BMI", "WHR", "TyG", "VAI", "QUICKI", "METS_IR", "TyG_BMI",  "TyG_WC",   "IL17A", "IFNGamma" , "HbA1c",  "GLICOSE", "INSULINA",  "HOMA.IR", "Systolic",  "Diastolic", "COLESTEROL",  "LDL", "HDL",  "VLDL" , "TRIGLICERIDES" , "TGO", "TGP", "GGT", "PCR",  "TNF", "IFNGamma" , "IL2", "IL4", "IL6", "IL10", "IL17A" )
